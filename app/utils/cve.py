...
def upCve():
    ...
    # Find last index of cve table
        ...
        if id_count > 0:
            ...
            flash('Table vulncve is not empty')
        # DEBUG
        else:
            log.info('Table vulncve is empty', extra=d)
            flash('Table vulncve is empty')
        # END DEBUG
